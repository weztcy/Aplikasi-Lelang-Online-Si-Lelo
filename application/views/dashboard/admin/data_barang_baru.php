          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="mytable" class="table table-striped table-bordered">
                ...
                <tbody>
                  <?php
                    $sql    = "SELECT * FROM abe_produk WHERE status = 'ready' OR status = 'oke' ORDER BY id_produk DESC";
                    ...
                    foreach ($barang as $row) {
                        ...
                        echo "<tr>
                            ...
                            <td><button class='btn btn-xs btn-flat btn-info' ><i class='fa fa-cubes' ></i> $row->status</button></td></tr>";     
                          $no++;
                      }
                  ?>
                </tbody>
